        ...
        <tbody>
            ...
            <tr>
                <td class="text-center">
                    <button type="button" class="btn btn-default btn-block" data-toggle="popover" data-container="body"
                        data-title="{LANG.change_weight}" data-bid="{ROW.bid}"
                        data-current-weight="{ROW.weight}">{ROW.weight}</button>
                </td>
                <td class="text-center"><strong>{ROW.bid}</strong></td>
                <td><a href="{ROW.link}">{ROW.title}</a> (<a href="{ROW.linksite}">{ROW.numnews}
                        {LANG.topic_num_news}</a>)</td>
                <td class="text-center">
                    <select class="form-control" id="id_adddefault_{ROW.bid}"
                ...
                <td class="text-center">
                    <select class="form-control" id="id_numlinks_{ROW.bid}"
                ...
                <td class="text-center">
                    ...
                    <em class="fa fa-trash-o fa-lg">&nbsp;</em> <a href="javascript:void(0);"
                        onclick="nv_del_block_cat({ROW.bid})">{GLANG.delete}</a>
                </td>
            </tr>
            <!-- END: loop -->
        </tbody>
...
<div id="popover-content" class="hide">
    <div class="popover-content">
        <div class="input-group item">
            <input type="text" class="form-control number new-weight" value="" maxlength="10" data-max="{TOTAL}"
            ...
            <span class="input-group-btn">
                ...
                <button type="button" class="btn btn-primary topic_change_weight" data-bid=""
                    data-current-weight="">OK</button>
            </span>
        </div>
